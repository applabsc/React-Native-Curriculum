...
Example setting `this.state.name` in constructor:
...
## Exercise
**Try this short coding challenge to apply what you've learned about components** https://snack.expo.io/HJrcZTFKX
